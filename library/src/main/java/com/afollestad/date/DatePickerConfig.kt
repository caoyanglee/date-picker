...
import com.afollestad.date.util.*
...
internal fun DatePickerConfig.Companion.create(
    ...
    return DatePickerConfig(
        ...
        manualInputLabel = ta.string(
            context,
            R.styleable.DatePicker_date_picker_manual_input_label
        ) {
        ...
        enableChineseCalendar = ta.getBoolean(
            R.styleable.DatePicker_date_picker_enble_chinese_lunar_calendar,
            false
        )
    ).also { ta.recycle() }
